...
Each TS was separately explored via the `forecast::autoplot()` function, which yields plots for the raw time series along with its ACF PACF.  Classical decomposition was performed for each TS via `decompose()` to understand 
...
Classical decomposition of each TS is shown in Figs. 7-9.  
