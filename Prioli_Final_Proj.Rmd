...
For predicting savings from lag-1 debt, the model suggested by `auto.arima()` was ARIMA(2,1,1) with drift.  Residual fit diagnostics are presented in Fig. 14.  The histogram of residuals shows reasonable normality with slight deviation from normality at the tails.  The ACF plot shows all values within the blue boundaries, the Ljung-Box test is not statistically significant, and ARCH/GARCH behavior is not seen (Fig. 15); thus the residuals are consistent with white noise.  All model terms are significant.
...
Modeling and forecasting performed very well in the univariate case where a strong trend was observed, and performed adequately in the bivariate case.  Future work includes incorporating additional predictor(s) into the savings vs. debt model and applying smoothing techniques to reduce the impact of volatility.
